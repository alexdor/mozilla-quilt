...
- [Mozilla Quilt Repo](#mozilla-quilt-repo)
        - [!!! This project uses prettier and editorconfig so lint your code before committing and respect the editorconfig specs (or use a plugin to do it for you http://editorconfig.org/#download). !!!](#this-project-uses-prettier-and-editorconfig-so-lint-your-code-before-committing-and-respect-the-editorconfig-specs-or-use-a-plugin-to-do-it-for-you-httpeditorconfigorgdownload)
